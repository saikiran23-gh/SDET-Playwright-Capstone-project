...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> Verify product title visible before compare
- Location: tests/compareandorder.spec.js:48:3
