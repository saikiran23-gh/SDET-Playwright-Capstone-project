...
- Name: authent.spec.js >> Authentication Management - nopCommerce Demo Store >> registration without last name
- Location: tests/authent.spec.js:74:3
