...
- Name: Navigation.spec.js >> Navigation and UI Validation - nopCommerce Demo Store >> search navigates to search results page
- Location: tests/Navigation.spec.js:21:3
