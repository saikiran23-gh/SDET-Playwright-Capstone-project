...
- Name: authent.spec.js >> Authentication Management - nopCommerce Demo Store >> registration without first name
- Location: tests/authent.spec.js:58:3
