...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> Verify orders page redirects to login page
- Location: tests/compareandorder.spec.js:74:3
