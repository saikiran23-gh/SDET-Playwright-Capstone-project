...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> product image visible before compare
- Location: tests/compareandorder.spec.js:65:3
