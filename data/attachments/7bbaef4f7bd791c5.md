...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> checkin compare button text
- Location: tests/compareandorder.spec.js:39:3
...
Locator: locator('.add-to-compare-list-button').first()
Expected substring: "Add to compare list"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.add-to-compare-list-button').first()
