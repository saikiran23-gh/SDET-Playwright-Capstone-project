...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> order history needs password field
- Location: tests/compareandorder.spec.js:98:3
