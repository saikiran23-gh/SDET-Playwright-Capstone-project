...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> books page has compare button
- Location: tests/compareandorder.spec.js:31:3
