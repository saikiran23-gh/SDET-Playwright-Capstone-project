...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> login page opens from order history
- Location: tests/compareandorder.spec.js:82:3
