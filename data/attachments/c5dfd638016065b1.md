...
- Name: authent.spec.js >> Authentication Management - nopCommerce Demo Store >> Verify register button directs to register page
- Location: tests/authent.spec.js:22:3
