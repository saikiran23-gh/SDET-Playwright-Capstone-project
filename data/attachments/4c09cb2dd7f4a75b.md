...
- Name: Navigation.spec.js >> Navigation and UI Validation - nopCommerce Demo Store >> Verify new products link navigation
- Location: tests/Navigation.spec.js:118:3
...
Call log:
  - waiting for locator('a[href="/newproducts"]').first()
