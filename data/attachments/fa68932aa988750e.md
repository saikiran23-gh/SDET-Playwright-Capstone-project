...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> product price is visible before compare
- Location: tests/compareandorder.spec.js:56:3
