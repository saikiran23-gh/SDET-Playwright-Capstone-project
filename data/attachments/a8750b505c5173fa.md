...
- Name: authent.spec.js >> Authentication Management - nopCommerce Demo Store >> login with empty email and password
- Location: tests/authent.spec.js:140:3
