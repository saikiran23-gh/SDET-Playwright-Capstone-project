...
- Name: authent.spec.js >> Authentication Management - nopCommerce Demo Store >> registration with invalid email
- Location: tests/authent.spec.js:88:3
