...
- Name: Navigation.spec.js >> Navigation and UI Validation - nopCommerce Demo Store >> Verify footer my account link redirects to login page
- Location: tests/Navigation.spec.js:148:3
...
Call log:
  - waiting for locator('a[href="/customer/info"]').last()
