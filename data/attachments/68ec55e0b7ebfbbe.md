...
- Name: authent.spec.js >> Authentication Management - nopCommerce Demo Store >> Verify login page opens successfully
- Location: tests/authent.spec.js:12:3
...
Expected pattern: /nopCommerce demo store/i
