...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> Verify order history login button visible
- Location: tests/compareandorder.spec.js:106:3
...
Locator: locator('button.login-button')
Expected: visible
Timeout: 5000ms
