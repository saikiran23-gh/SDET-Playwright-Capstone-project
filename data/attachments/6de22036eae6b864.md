...
- Name: compareandorder.spec.js >> Compare and Order Management - nopCommerce Demo Store >> order history needs email field
- Location: tests/compareandorder.spec.js:90:3
